    ...
    try:
        ...
        for node_namespace in robots:
            node = SimulationTestNode(
                "test_multirobot_simulation", namespace=node_namespace
            )
        ...
        for node_namespace in robots:
            ...
            speed_test(
                node, "Test velocity in x direction", v_x=0.7, robot_name=node_namespace
            )
            speed_test(
                node, "Test velocity in yaw", v_yaw=3.0, robot_name=node_namespace
            )
